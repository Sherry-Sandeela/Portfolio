...
const Contact = () => {
  return (
    ...
    <section className="contact bg-[#1a253f] text-white py-12 px-6" id="contact">
                ...
                <form className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" className="w-full border border-[#28365f] bg-[#151A33] rounded p-2 text-white placeholder-gray-400 focus:border-[#4d79fc] outline-none"/>
                        </div>
                        <div>
                            <label className="block mb-1 font-medium">Email</label>
                            <input type="email" className="w-full border border-[#28365f] bg-[#151A33] rounded p-2 text-white placeholder-gray-400 focus:border-[#4d79fc] outline-none"  />
                        </div>
                        
                    </div>
                    <div>
                            <label className="block mb-1 font-medium">Massage</label>
                            <textarea rows="5" className="w-full border border-[#28365f] bg-[#151A33] rounded p-2 text-white placeholder-gray-400 focus:border-[#4d79fc] outline-none" />
                        </div>
                        <button type='submit' className='bg-blue-600 text-white py-2 px-6 rounded hover:bg-blue-700 transition'>Submit</button>
                </form>
            </div>
        </div>
        </div>
