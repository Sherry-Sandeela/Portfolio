      ...
      <div className="grid md:grid-cols-2 gap-24">
        ...
        <div className="space-y-6">
          ...
          <p className="text-[#848db3] text-[14px] leading-relaxed">
           Passionate Full Stack Developer skilled in PHP, Laravel, Livewire, and React.
            I enjoy building dynamic, user-friendly, and high-performing web applications from start to finish — from backend logic to engaging frontend design.
            Constantly exploring new techniques to write cleaner, faster, and more maintainable code.
          </p>
          <a 
            href="/Portfolio/M.Sheraz Sandeela.pdf"
            download="My-CV"
           className="bg-[#4d79fc]/10 text-[#4d79fc] text-xs px-4 py-1 rounded hover:bg-[#4d79fc]/20 transition">
            Download CV
          </a>
        </div>
        {/* Right Side */}
